                    ...
                    <div className="row">
                        <div className="col-md-5">
                            <div className="left-container text-start">
                                ...
                                <p className="mt-5">
                                    <p>© TrustCare. All rights reserved. Privacy Policy Terms & Condition</p>
                                </p>
                            </div>
                        </div>
                        <div className="col-md-2">
                            <div className="footer-menu-container">
                                <ul>
                                    ...
                                    <li className="footer-menu">  <Link className="nav-link" to="/services">Services</Link></li>
                                    <li className="footer-menu"> <Link className="nav-link" to="/patient">patient-Resources</Link></li>
                                    <li className="footer-menu">  <Link className="nav-link" to="/kids">TrustCare-Kids</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-5">
