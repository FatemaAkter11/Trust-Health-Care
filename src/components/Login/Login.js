...
const Login = () => {
    const { signInUsingGoogle,
        ...
        toggleLogin,
        handleRegistration,
        handleResetPassword, isLogin, error } = useAuth();
        ...
        <div>
            <div className="mx-5">
                ...
                <form onSubmit={handleRegistration}  >
                    ...
                    <button onClick={handleResetPassword} type="button" className="btn btn-secondary btn-sm py-2 mx-4">Reset Password</button>
                </form>

                <br /><br />
                <button className="btn btn-warning mx-1" onClick={signInUsingGoogle}> Google Sign In</button>
                <br />
                <button className="btn btn-warning my-2" onClick={signInUsingGithub}>  GitHub Sign In </button>
                <br />
